...
After evaluating existing tools, jscodeshift may be the best approach:
...
Also consider if the Acorn parser may be useful
...
4. **APIs** - Either CLI interface or programmatic API
