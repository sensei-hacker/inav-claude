...
Create comprehensive documentation (`README.md`) for the GPS testing tools in `claude/developer/scripts/testing/inav/gps/` that serves as the main entry point for understanding and using all the scripts and tools in that directory.

## Objectives

### 1. Create Main README.md

**Location:** `claude/developer/scripts/testing/inav/gps/README.md`
...
**Current file:** `claude/developer/scripts/testing/inav/gps/test_motion_simulator.sh`
